...
- (void)emailButtonWasPressed 
{
    if ([MFMailComposeViewController canSendMail]) {
        ...
        [mailComposer setToRecipients:@[@"boxed@killingar.net"]];
...
- (NSString *)tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section
{
    if (section == 0) {
        ...
        return @"Although we appreciate feedback in reviews on the App Store, if you have questions you want us to answer, please contact us by email so we can help. Apple doesn't allow us to respond to questions in reviews.";
    }
}
