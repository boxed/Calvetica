...
@interface CVEventHourViewController ()
...
@implementation CVEventHourViewController
...
- (void)viewWillAppear:(BOOL)animated
{
	...
	for (CVViewButton *button in @[ _startTimeButton, _endTimeButton, _allDayButton ]) {
		...
		button.backgroundColorNormal	= calSecondaryText();
		button.textColorNormal			= calBackgroundColor();
	}
