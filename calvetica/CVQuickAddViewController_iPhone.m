...
@property (nonatomic, strong) IBOutlet CVRoundedButton *addButton;
@property (nonatomic, strong) IBOutlet CVRoundedButton *moreButton;
@property (nonatomic, strong) IBOutlet CVRoundedButton *closeButton;
@property (nonatomic, strong) IBOutlet UIView *containerView;
@property (nonatomic, strong) IBOutlet UITextField *titleTextField;
@property (nonatomic, strong) IBOutlet UIButton *ampmButton;
@property (nonatomic, strong) IBOutlet UIControl *startTimeButton;
@property (nonatomic, strong) IBOutlet UILabel *startLabel;
@property (nonatomic, strong) IBOutlet UILabel *startTimeLabel;
@property (nonatomic, strong) IBOutlet UILabel *startDayLabel;
@property (nonatomic, strong) IBOutlet UIControl *endTimeButton;
@property (nonatomic, strong) IBOutlet UILabel *endLabel;
@property (nonatomic, strong) IBOutlet UILabel *endTimeLabel;
@property (nonatomic, strong) IBOutlet UILabel *endDayLabel;
@property (nonatomic, strong) IBOutlet UIView *allDayEndDayView;
@property (nonatomic, strong) IBOutlet UILabel *allDayEndDayLabel;
@property (nonatomic, strong) IBOutlet UILabel *allDayStartDayLabel;
@property (nonatomic, strong) IBOutlet UIView *durationTablesView;
@property (nonatomic, strong) IBOutlet UITableView *hoursTableView;
@property (nonatomic, strong) IBOutlet UITableView *minutesTableView;
@property (nonatomic, strong) IBOutlet UIView *allDayTableHolderView;
@property (nonatomic, strong) IBOutlet UITableView *allDayTableView;
@property (nonatomic, strong) IBOutlet UIScrollView *allDayScrollView;
@property (nonatomic, strong) IBOutlet UIView *allDayScrollViewPageOne;
@property (nonatomic, strong) IBOutlet UIView *allDayScrollViewPageTwo;
...
- (void)loadTableViews 
{
    ...
    for (int i = 0; i < [hoursTitles count]; i++) {
        [_hoursArray push:[CVQuickAddViewController_iPhone dictionaryFromTitle:[hoursTitles objectAtIndex:i] value:[hoursValues objectAtIndex:i]]];
    }
    
    // build the minutesArray
    for (int i = 0; i < [minutesTitles count]; i++) {
        [_minutesArray push:[CVQuickAddViewController_iPhone dictionaryFromTitle:[minutesTitles objectAtIndex:i] value:[minutesValues objectAtIndex:i]]];
    }
...
- (void)viewDidLoad 
{
    ...
    if ([CVSettings isTwentyFourHourFormat]) {
        [self.ampmButton setImage:[UIImage imageNamed:@"cleartime"] forState:UIControlStateNormal];
...
- (void)calendarPickerController:(CVCalendarPickerViewController_iPhone *)controller didPickCalendar:(EKCalendar *)cal 
{
