...
#import "CVFiveBarButton.h"

@implementation CVFiveBarButton
...
- (void)setupPencil
{
    ...
    [[_pencil move] to:CGPointMake(CGRectGetMinX(rect), CGRectGetMaxY(rect) - CVStackedBarButtonSpacing * 4)];
    [[_pencil draw] to:CGPointMake(CGRectGetMaxX(rect), CGRectGetMaxY(rect) - CVStackedBarButtonSpacing * 4)];
}
