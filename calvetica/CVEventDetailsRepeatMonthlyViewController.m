...
@interface CVEventDetailsRepeatMonthlyViewController ()
...
@implementation CVEventDetailsRepeatMonthlyViewController
...
- (id)initWithStartDate:(NSDate *)date recurrenceRule:(EKRecurrenceRule *)rule 
{
    ...
    if (self) {
        ...
        self.eachDayButtonLabel.text = [CVMonthlyRecurrenceSelectionViewController daysOfTheMonthString:self.daysOfTheMonth];
...
{
    CVMonthlyRecurrenceSelectionViewController *monthlyRecurrenceSelectionViewController = [[CVMonthlyRecurrenceSelectionViewController alloc] initWithTargetView:self.eachDayButton selectedDays:self.daysOfTheMonth];
