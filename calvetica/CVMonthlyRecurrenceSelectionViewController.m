...
#import "CVMonthlyRecurrenceSelectionViewController.h"
...
- (void)viewWillAppear:(BOOL)animated 
{
    ...
    _selectedDaysLabel.text = [CVMonthlyRecurrenceSelectionViewController daysOfTheMonthString:_selectedDays];
